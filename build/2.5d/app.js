...
window.onload = function () {
  ...
  for (var i = 0; i < numShapes; i++) {
    shapes[i] = {
      x: _Utils2.default.randomRange(-1000, 1000),
      y: _Utils2.default.randomRange(-1000, 1000),
      z: _Utils2.default.randomRange(0, 100000)
    };
  }
  ...
  function update() {
    ...
    for (var _i = 0; _i < numShapes; _i++) {
      var perspective = fl / (fl + shapes[_i].z);

      ctx.save();
      ctx.scale(perspective, perspective);
      ctx.translate(shapes[_i].x, shapes[_i].y);
      ctx.beginPath();
      ctx.arc(shapes[_i].x, shapes[_i].y, 5, Math.PI * 2, false);
...
},{"../../src/lib/AnimationPlayer":3,"../../src/lib/Particle":4,"../../src/lib/Utils":5}],2:[function(require,module,exports){
"use strict";
