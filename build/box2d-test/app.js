...
var _B2Box = require('./lib/B2Box');

var _B2Box2 = _interopRequireDefault(_B2Box);
...
var _Rectangle = require('./lib/Rectangle');

var _Rectangle2 = _interopRequireDefault(_Rectangle);

var _Polygon = require('./lib/Polygon');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var SCALE = 30;
  var FPS = 60; // This is experimental: it may cause conflicts with AnimationPlayer's fps?
  var DEBUG_DRAW = false;

  var box = new _B2Box2.default(FPS, false, WIDTH, HEIGHT, SCALE, DEBUG_DRAW, ctx);
  var player = new _AnimationPlayer2.default({ fps: FPS });
  ...
  for (var i = 0; i < totalBalls; i++) {
    var ball = {
      id: _Utils2.default.randomUniueID(),
      x: _Utils2.default.randomRange(0, box.toB2p(WIDTH * 2)),
      y: _Utils2.default.randomRange(0, box.toB2p(HEIGHT * 2)),
      radius: _Utils2.default.randomRange(0.5, 1),
      color: _Utils2.default.randomColor(),
      angle: _Utils2.default.randomRange(0, Math.PI * 2)
    };

    initialState.push(ball);
  }

  for (var _i = 0; _i < initialState.length; _i++) {
    world[initialState[_i].id] = build(initialState[_i]);
  }
  ...
  function build(def) {
    if (def.radius) {
      return new _Circle2.default(def.id, def.x, def.y, def.angle, NULL_CENTER, def.color, def.strength, def.heading, def.speed, def.radius);
    } else if (def.polys) {
      return new _Polygon2.default(def.id, def.x, def.y, def.angle, NULL_CENTER, def.color, def.strength, def.polys);
    } else {
      return new _Rectangle2.default(def.id, def.x, def.y, def.angle, NULL_CENTER, def.color, def.strength, def.halfWidth, def.halfHeight);
    }
  }
});

},{"../../src/lib/AnimationPlayer":9,"../../src/lib/Utils":10,"./lib/B2Box":3,"./lib/Circle":4,"./lib/Entity":5,"./lib/Polygon":6,"./lib/Rectangle":7}],3:[function(require,module,exports){
'use strict';
...
var b2Vec2 = _box2dweb2.default.Common.Math.b2Vec2,
    b2BodyDef = _box2dweb2.default.Dynamics.b2BodyDef,
    b2Body = _box2dweb2.default.Dynamics.b2Body,
    b2FixtureDef = _box2dweb2.default.Dynamics.b2FixtureDef,
    b2Fixture = _box2dweb2.default.Dynamics.b2Fixture,
    b2World = _box2dweb2.default.Dynamics.b2World,
    b2MassData = _box2dweb2.default.Collision.Shapes.b2MassData,
    b2PolygonShape = _box2dweb2.default.Collision.Shapes.b2PolygonShape,
    b2CircleShape = _box2dweb2.default.Collision.Shapes.b2CircleShape,
    b2DebugDraw = _box2dweb2.default.Dynamics.b2DebugDraw,
    b2RevoluteJointDef = _box2dweb2.default.Dynamics.Joints.b2RevoluteJointDef;

var B2Box = function () {
  function B2Box(intervalRate, adaptive, width, height, scale, debugDraw, ctx) {
    _classCallCheck(this, B2Box);
  ...
  _createClass(B2Box, [{
    ...
    value: function update() {
      ...
      for (var a in this.bodiesMap) {
        for (var b in this.bodiesMap) {
          if (a === b) {
            continue;
          }
    ...
    key: 'getRadius',
    value: function getRadius(b) {
      var f = b.GetFixtureList();
      return f.m_shape.m_radius;
    }
  }, {
    key: 'setBodies',
    value: function setBodies(bodyEntities) {
    ...
    key: 'registerBody',
    value: function registerBody(bodyDef) {
    ...
    key: 'setupDebugDraw',
    value: function setupDebugDraw(ctx, alpha) {
      alpha = alpha || 0.5;
    ...
    key: 'toB2p',
    value: function toB2p(v) {
      return v / this.scale;
    }
  }, {
    key: 'gravitate',
    value: function gravitate(a, b, gravityFactor) {
      gravityFactor = 9.6;
      ...
      var radiusSum = this.getRadius(a) + this.getRadius(b);
      var massFactor = a.m_mass * b.m_mass;

      var aPos = a.GetWorldCenter();
      ...
      var surfaceDist = distance - radiusSum;

      force.Normalize();
      var strength = gravityFactor * massFactor / (distance * distance);
...
exports.default = B2Box;

},{"box2dweb":1}],4:[function(require,module,exports){
'use strict';
...
var Circle = function (_Entity) {
  _inherits(Circle, _Entity);

  function Circle(id, x, y, angle, center, color, strength, heading, speed, radius) {
    _classCallCheck(this, Circle);

    color = color || 'aqua';

    var _this = _possibleConstructorReturn(this, (Circle.__proto__ || Object.getPrototypeOf(Circle)).call(this, id, x, y, angle, center, color, strength, heading, speed));
  ...
  _createClass(Circle, [{
    ...
    value: function update(state) {
      _get(Circle.prototype.__proto__ || Object.getPrototypeOf(Circle.prototype), 'update', this).call(this, state);
...
var Entity = function () {
  function Entity(id, x, y, angle, center, color, strength, heading, speed) {
  ...
  _createClass(Entity, [{
    key: 'hit',
    value: function hit(impulse, source) {
      this.isHit = true;
      if (this.strength) {
...
var Polygon = function (_Entity) {
  _inherits(Polygon, _Entity);

  function Polygon(id, x, y, angle, center, color, strength, polys) {
    _classCallCheck(this, Polygon);

    var _this = _possibleConstructorReturn(this, (Polygon.__proto__ || Object.getPrototypeOf(Polygon)).call(this, id, x, y, angle, center, color, strength));
...
var Rectangle = function (_Entity) {
  ...
  function Rectangle(id, x, y, angle, center, color, strength, halfWidth, halfHeight) {
    _classCallCheck(this, Rectangle);

    var _this = _possibleConstructorReturn(this, (Rectangle.__proto__ || Object.getPrototypeOf(Rectangle)).call(this, id, x, y, angle, center, color, strength));
